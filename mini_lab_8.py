#Постановка задачи: с помощью библиотеки sklearn и matplotlib реализовать 3 метода регрессии на примере двумерных данных на языке программирования python
import numpy as np
